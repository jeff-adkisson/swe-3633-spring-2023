...
namespace StateMachine.MVC.Controllers;
...
public class HomeController : Controller
{
    ...
    {
        _logger.Log(LogLevel.Debug, "Text to scan: {TextToScan}", model.TextToScan);
        var matches = Email.Finder.Find(model.TextToScan).ToList();
